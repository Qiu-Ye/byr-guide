window.onload=function(){
    var guideArr=[
        {id:"ban_ner_wrapper",pic_src:"images/guide2.png",pic_btn:"210,146",pic_position:"bottom"},
        {id:"u_login",pic_src:"images/guide1.png",pic_btn:"209,143",pic_position:"right"},
        {id:"xlist",pic_src:"images/guide1.png",pic_btn:"209,143"},
      //  {id:"picshow",pic_src:"images/guide2.png",pic_btn:"209,143",pic_position:"bottom"},
      //  {id:"recommend",pic_src:"images/guide3.png",pic_btn:"207,153",pic_position:"bottom"},
      //  {id:"postrank",pic_src:"images/guide3.png",pic_btn:"207,153"}
        ];
    var finpic={pic_src:"images/guide3.png",pic_btn:"207,153",pic_position:"center"};
    guide(guideArr);
};
...
function guide(guideArray,finishpic){
   ...
   _creatIntroItem(currentStep);
    ...
    function _creatIntroItem(targetStep){
        ...
        aElem.style.position='fixed';
        aElem.style.zIndex="9999998";
        ...
        aA.setAttribute('style','top:'+aA_btn[0]+ 'px; left: '+aA_btn[1]+'px');
